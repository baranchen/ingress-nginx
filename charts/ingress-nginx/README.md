...
[ingress-nginx](https://github.com/baranchen/ingress-nginx) Ingress controller for Kubernetes using NGINX as a reverse proxy and load balancer

![Version: 4.30.2](https://img.shields.io/badge/Version-4.30.2-informational?style=flat-square) ![AppVersion: 1.30.2](https://img.shields.io/badge/AppVersion-1.30.2-informational?style=flat-square)
...
| controller.image.tag | string | `"v1.30.2"` |  |
